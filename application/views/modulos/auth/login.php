                    ...
                    <div class="row">
                        <div class="col-md-4 left">
                            <div class="login-box">
                                <div class="panel">
                                    <a href="index.html">
                                        <img class="logomarca" src="<?php echo base_url(); ?>assets/images/logomarca_login.png">
                                    </a>
                                </div>
                        ...
                        <div class="col-md-8 infos-unidade">
                            <h3 class="infos-titulo">Sejam bem-vindos ao Sistema de Eventos.</h3>
                            <p class="infos-destaques"><i class="fa fa-arrow-right"></i> Aqui você encontrará tudo sobre :</p>
                            <p class="infos-destaques"><i class="fa fa-book"></i> Publicar Eventos.</p>
                            <p class="infos-destaques"><i class="fa fa-money"></i> Inscrever-se em um ou mais Evento.</p>
                            <p class="infos-destaques"><i class="fa fa-users"></i> Gerenciamento do seu Evento.</p>
                            <p class="infos-destaques"><i class="fa fa-archive"></i> Entre outras funcionalidades.</p>
                        </div>
                    </div><!-- Row -->
                </div><!-- Main Wrapper -->
            </div><!-- Page Inner -->

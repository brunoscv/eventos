										...
										<table class="display table" style="width: 100%; cellspacing: 0;">
											...
											<tbody>
												...
												<tr>
													...
													<td class="td-actions"><a href="<?php echo site_url('perfis/editar/'.$perfil->id); ?>" class="btn btn-small btn-success"><i class="btn-icon-only fa fa-pencil"> </i></a><a href="<?php echo site_url("perfis/delete/".$perfil->id)?>" class="btn btn-danger btn-small"><i class="btn-icon-only fa fa-times"> </i></a></td>
												</tr>
												<?php endforeach; ?>
											</tbody>
										</table>
